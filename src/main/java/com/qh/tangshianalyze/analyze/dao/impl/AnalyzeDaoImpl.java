package com.qh.tangshianalyze.analyze.dao.impl;
...
public class AnalyzeDaoImpl implements AnalyzeDao {
    ...
    public List<AuthorCount> analyzeAuthorCount() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            logger.error("Dataabase query occur exception {}.",e.getMessage());
        }
        return datas;
    }
    ...
    public List<PoetryInfo> queryAllPoetryInfo() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            while (rs.next()){
                ...
                //ORM对象关系映射：mybatis Spring-Data-JDBC hibernate JOOQ TopLink dbUtils
